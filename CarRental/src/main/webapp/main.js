...
const routes = [
    {
        path: '', component: _home_home_component__WEBPACK_IMPORTED_MODULE_2__["HomeComponent"], data: { title: 'Home' }
    }
];
...
module.exports = __webpack_require__(/*! C:\Development\iXeon\CarRental\frontend\src\main.ts */"./src/main.ts");
